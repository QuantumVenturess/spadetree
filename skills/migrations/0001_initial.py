...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Skill', fields ['interest', 'user']
        db.create_unique('skills_skill', ['interest_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Skill', fields ['interest', 'user']
        db.delete_unique('skills_skill', ['interest_id', 'user_id'])
