...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_profile', 'about', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Profile.about'
        db.alter_column('users_profile', 'about', self.gf('django.db.models.fields.TextField')(default=''))
