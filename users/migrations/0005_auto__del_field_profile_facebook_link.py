...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.facebook_link'
        db.delete_column('users_profile', 'facebook_link')


    def backwards(self, orm):
        # Adding field 'Profile.facebook_link'
        db.add_column('users_profile', 'facebook_link',
