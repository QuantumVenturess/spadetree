...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notification.value'
        db.delete_column('notifications_notification', 'value')

        # Adding field 'Notification.action'
        db.add_column('notifications_notification', 'action',
    ...
    def backwards(self, orm):
        # Adding field 'Notification.value'
        db.add_column('notifications_notification', 'value',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Notification.action'
        db.delete_column('notifications_notification', 'action')
