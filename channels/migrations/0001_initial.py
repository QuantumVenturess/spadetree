...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('channels_channel', (
            ...
            ('choice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['choices.Choice'], null=True, blank=True)),
            ('choice_note', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['choices.ChoiceNote'], null=True, blank=True)),
