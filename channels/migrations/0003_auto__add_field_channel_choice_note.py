...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.choice_note'
        db.add_column('channels_channel', 'choice_note',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['choices.ChoiceNote'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.choice_note'
        db.delete_column('channels_channel', 'choice_note_id')
