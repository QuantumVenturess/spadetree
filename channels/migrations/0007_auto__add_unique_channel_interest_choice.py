...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Channel', fields ['interest', 'choice']
        db.create_unique('channels_channel', ['interest_id', 'choice_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Channel', fields ['interest', 'choice']
        db.delete_unique('channels_channel', ['interest_id', 'choice_id'])
