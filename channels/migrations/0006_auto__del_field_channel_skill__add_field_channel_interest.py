...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Channel.skill'
        db.delete_column('channels_channel', 'skill_id')

        # Adding field 'Channel.interest'
        db.add_column('channels_channel', 'interest',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interests.Interest'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Channel.skill'
        db.add_column('channels_channel', 'skill',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skills.Skill'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Channel.interest'
        db.delete_column('channels_channel', 'interest_id')
