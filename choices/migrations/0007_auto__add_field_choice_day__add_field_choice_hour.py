...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Choice.day'
        db.add_column('choices_choice', 'day',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['days.Day']),
                      keep_default=False)

        # Adding field 'Choice.hour'
        db.add_column('choices_choice', 'hour',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['hours.Hour']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Choice.day'
        db.delete_column('choices_choice', 'day_id')

        # Deleting field 'Choice.hour'
        db.delete_column('choices_choice', 'hour_id')
