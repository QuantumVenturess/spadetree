...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Choice'
        db.create_table('choices_choice', (
            ...
            ('tutee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tutee_choices', to=orm['auth.User'])),
            ('tutor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tutor_choices', to=orm['auth.User'])),
        ))
        db.send_create_signal('choices', ['Choice'])


    def backwards(self, orm):
        # Deleting model 'Choice'
        db.delete_table('choices_choice')
