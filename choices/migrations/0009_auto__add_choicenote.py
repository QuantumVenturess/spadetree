...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChoiceNote'
        db.create_table('choices_choicenote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('choice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['choices.Choice'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('choices', ['ChoiceNote'])


    def backwards(self, orm):
        # Deleting model 'ChoiceNote'
        db.delete_table('choices_choicenote')
