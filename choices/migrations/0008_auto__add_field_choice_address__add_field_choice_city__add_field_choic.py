...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Choice.address'
        db.add_column('choices_choice', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Choice.city'
        db.add_column('choices_choice', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cities.City'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Choice.date'
        db.add_column('choices_choice', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Choice.address'
        db.delete_column('choices_choice', 'address')

        # Deleting field 'Choice.city'
        db.delete_column('choices_choice', 'city_id')

        # Deleting field 'Choice.date'
        db.delete_column('choices_choice', 'date')
