...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Choice.interest'
        db.add_column('choices_choice', 'interest',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['interests.Interest']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Choice.interest'
        db.delete_column('choices_choice', 'interest_id')
