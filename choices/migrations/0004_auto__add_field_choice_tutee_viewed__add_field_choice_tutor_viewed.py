...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Choice.tutee_viewed'
        db.add_column('choices_choice', 'tutee_viewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Choice.tutor_viewed'
        db.add_column('choices_choice', 'tutor_viewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Choice.tutee_viewed'
        db.delete_column('choices_choice', 'tutee_viewed')

        # Deleting field 'Choice.tutor_viewed'
        db.delete_column('choices_choice', 'tutor_viewed')
    ...
    models = {
        ...
        'choices.choice': {
            ...
            'tutee_viewed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
